...
function baby_vp_plugin_action_links( $links ) {
    ...
    $diagnostics_link = '<a href="' . esc_url( admin_url( 'admin.php?page=baby-vp-diagnostics' ) ) . '">Diagnostics</a>';

    array_unshift( $links, $diagnostics_link );
